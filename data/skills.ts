...
export const skills: Skill[] = [
  // Technical
  {
    ...
    selfCritique:
      "I consider my current level in software engineering and clean architecture to be proficient, with a solid theoretical foundation and growing practical experience.\nMy goal is to progressively move from a proficient level to an expert level by confronting architectural decisions in larger and more constrained systems. \nI am able to:\n\n- Make justified architectural decisions\n- Understand the long-term impact of technical choices\n- Refactor and improve existing application structures\n\nIn addition, I am aware that true expertise in this area requires:\n\n- Exposure to larger-scale systems\n- Reviewing complex real-world architectures\n- Learning from practical mistakes and constraints",
    nextSteps:
  ...
  },
  {
    ...
    selfCritique: "I assess my proficiency level in frontend development as advanced.\nDespite this level, I am aware that frontend development involves constant trade-offs between performance, maintainability, and user experience. \nI still need to deepen my expertise in complex state management scenarios, frontend performance profiling, and long-term architectural consistency in large-scale applications. \nI can design and implement complete frontend applications independently, choose appropriate frameworks depending on project constraints, and structure codebases for long-term maintainability.\n\n However, I remain aware that frontend engineering is a rapidly evolving field. Key areas I continue to strengthen include performance optimization, advanced state management strategies, and architectural consistency in large-scale applications.",
    nextSteps:
  ...
  },
  {
    ...
    selfCritique:
      "I consider my current level in databases and data modeling to be proficient, with strong foundations in relational modeling and growing expertise in performance-oriented design.\nMy objective is to evolve toward advanced level expertise by working on larger datasets, performance critical queries, and complex relational schemas.\nI am able to:\n\n- Design logical and coherent data models\n- Understand the impact of database design on performance\n- Align database structures with business logic\n\nIn addition, I continue to improve my expertise in:\n\n- Optimizing complex SQL queries\n- Deepening my understanding of performance mechanisms such as indexing and query optimization",
    nextSteps:
  ...
  },
  {
    ...
    selfCritique:
      "I assess my proficiency level in DevOps & Tooling as solid, with a clear awareness of my current limits.\nI am able to:\n\n- Set up reproducible execution environments\n- Use Git effectively in team-based projects\n- Understand CI/CD concepts and their impact on software quality\n\nIn addition, I recognize that this domain requires deeper expertise in large-scale and industrial environments, which I aim to acquire progressively.",
    nextSteps:
